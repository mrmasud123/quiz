...
include 'config.inc.php';
        ...
        $user=mysqli_real_escape_string($con,$_POST['user']);if(empty($_POST['email'])){
            ...
            echo json_encode(array('error'=>'Passowrd Field is Empty.','flag'=>'error'));
                ...
                $emailCheckQuery = "SELECT email from teachers where email='$email'";
                $passCheckQuery = "SELECT password from teachers where password='$password'";
                $emailCheckResult = mysqli_query($con, $emailCheckQuery);
                $passCheckResult = mysqli_query($con, $passCheckQuery);
                $name = "SELECT * from teachers where email='$email' && password='$password'";
